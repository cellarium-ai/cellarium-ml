...
EXAMPLES = [
    (
        ...
        "--data.filenames https://storage.googleapis.com/dsp-cellarium-cas-public/test-data/test_0.h5ad "
        "--data.shard_size 100 --data.max_cache_size 2 "
        "--data.convert.X cellarium.ml.data.util.densify "
        "--data.convert.var_names cellarium.ml.data.util.pandas_to_numpy "
        "--data.batch_size 5 "
        "--data.num_workers 1 "
    ...
    (
        ...
        "--data.convert.X cellarium.ml.data.util.densify "
        "--data.convert.var_names cellarium.ml.data.util.pandas_to_numpy "
        "--data.convert.obs_names cellarium.ml.data.util.pandas_to_numpy "
        "--data.batch_size 5 "
        "--data.num_workers 1 "
        "--trainer.accelerator cpu "
        "--trainer.devices 1 "
    ...
    (
        ...
        "--data.filenames https://storage.googleapis.com/dsp-cellarium-cas-public/test-data/test_{0..1}.h5ad "
        "--data.shard_size 100 "
        "--data.max_cache_size 2 "
        "--data.convert.X cellarium.ml.data.util.densify "
        "--data.batch_size 50 "
    ...
    (
        ...
        "--trainer.accelerator cpu "
        "--trainer.devices 1 "
        "--trainer.callbacks cellarium.ml.callbacks.PredictionWriter "
