...
@register_model
def custom_logistic_regression(args: ArgsType = None) -> None:
    r"""
    CLI to run the :class:`cellarium.ml.models.CustomLogisticRegression` model.
    ...
    cli = lightning_cli_factory(
        "cellarium.ml.models.CustomLogisticRegression",
        link_arguments=[
            LinkArguments(
                ("model.cpu_transforms", "model.transforms", "data"),
                "model.model.init_args.var_names_g",
