...
@register_model
def bio_gpt(args: ArgsType = None) -> None:
    r"""
    ...
    """
    cli = lightning_cli_factory(
        "cellarium.ml.models.cellarium_gpt.BioGPT",
        link_arguments=[
            LinkArguments(("model.transforms", "data"), "model.model.init_args.var_names_g", compute_var_names_g)
        ],
    )
...
@register_model
def cellarium_bert(args: ArgsType = None) -> None:
    r"""
    CLI to run the :class:`cellarium.ml.models.CellariumGPT` model.
    ...
    """
    cli = lightning_cli_factory(
        "cellarium.ml.models.cellarium_bert.CellariumBERT",
        link_arguments=[
            LinkArguments(("model.transforms", "data"), "model.model.init_args.var_names_g", compute_var_names_g)
        ],
    )
