...
def write_prediction(
    ...
    #output_path = "gs://cellarium-file-system/curriculum/lrexp_human_validation_split_20241126/model_predictions/Model_5_alpha_half_normalized/missing_hop_scores/hop_scores_extract_81_85_"+str(postfix)+".csv"
    #output_path = str(output_dir)+"/hop_scores_extract_"+str(postfix)+".csv"
    #output_path = os.path.join(output_dir, f"hop_scores_extract_{postfix}.csv")
    output_path = "gs://cellarium-file-system/curriculum/lrexp_human_validation_split_20241126/model_predictions/Model_variation_5_alpha_zero_normalized/hop_score_outputs_trial/hop_scores_extract_"+str(postfix)+".csv"
