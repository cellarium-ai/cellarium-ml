...
foldername_dict = {
                    ...
                    13: ["jejunum-small-intestine-raw", "../lightning_logs/bigrun/checkpoints/epoch=3-step=300000.ckpt", "../example_configs/scvi_train_jejunum_small_intestine.yaml", "../data/coarsed_normal/concatenated/train/extract_{0..37}.h5ad", ["cell_type","tissue"],"var_names"],
                    14: ["jejunum-small-intestine-raw", "../lightning_logs/version_87/checkpoints/epoch=29-step=10350.ckpt", "../example_configs/scvi_predict_jejunum_small_intestine.yaml", "../data/coarsed_normal/concatenated/train/extract_{0..37}.h5ad", ["cell_type","tissue"],"var_names"],
                    }
