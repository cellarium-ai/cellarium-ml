...
def parse_args():
    ...
    parser.add_argument("--cell_index", type=int, default=0,
                        help="Index of the cell in the validation AnnData to analyze")
    
    # Gene expression range determination parameters
    parser.add_argument("--query_chunk_size", type=int, default=1000,
                        help="Chunk size for gene expression query (default: 1000)")
    parser.add_argument("--total_prob_mass", type=float, default=0.5,
                        help="Total probability mass (default: 0.5)")
    parser.add_argument("--max_counts", type=int, default=1000,
                        help="Maximum counts (default: 1000)")
    parser.add_argument("--symmetric_range_pad", type=int, default=1,
                        help="Symmetric range pad (default: 1)")
    parser.add_argument("--max_query_genes", type=int, default=None,
                        help="Maximum number of query genes (default: None, meaning use all)")
    parser.add_argument("--total_mrna_umis", type=float, default=None,
    ...
    parser.add_argument("--n_points", type=int, default=5,
                        help="Number of points for the linear response analysis (default: 5)")
    parser.add_argument("--query_chunk_size_linear_response", type=int, default=64,
